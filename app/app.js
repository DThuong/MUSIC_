...
function createChart(data) {
  ...
  const myChart = new Chart(ctx, {
    type: "pie", // Đổi loại biểu đồ thành "pie" cho biểu đồ tròn
    data: {
      labels: labels,
      datasets: [
        {
          ...
          backgroundColor: [
            // Đặt màu sắc cho từng phần của biểu đồ tròn
            "rgba(75, 192, 192, 0.2)",
            "rgba(255, 99, 132, 0.2)",
            "rgba(255, 205, 86, 0.2)",
            "rgba(54, 162, 235, 0.2)",
            ...
            "rgba(255, 159, 64, 0.2)",
            // Thêm màu sắc khác nếu bạn có nhiều hơn 6 phần
          ],
          borderColor: [
            // Đặt màu viền cho từng phần của biểu đồ tròn
            "rgba(75, 192, 192, 1)",
            "rgba(255, 99, 132, 1)",
            "rgba(255, 205, 86, 1)",
            "rgba(54, 162, 235, 1)",
            "rgba(153, 102, 255, 1)",
            "rgba(255, 159, 64, 1)",
            // Thêm màu viền khác nếu bạn có nhiều hơn 6 phần
          ],
          borderWidth: 1,
        },
      ],
  ...
  const myChart1 = new Chart(ctx1, {
    type: "bar", // Đổi loại biểu đồ thành "pie" cho biểu đồ tròn
    data: {
      labels: labels,
      datasets: [
        {
